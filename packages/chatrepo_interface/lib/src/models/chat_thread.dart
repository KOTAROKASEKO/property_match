...
class ChatThread {
  ...
  static ChatThread fromFirestore(DocumentSnapshot<Map<String, dynamic>> doc, String role) {
    String generalNotePath = role == 'agent' ? 'agentGeneralNote':'tenantGeneralNote';
    String viewingNotePath = role== 'agent' ? 'agentViewingNote':'tenantViewingNote';
    String photoImagePath = role == 'agent' ? 'agentphotoPath':'tenantPhotoPath';
    String generalphotoImagePath = role == 'agent' ? 'agentGeneralPhotoPath':'tenantGeneralPhotoPath';
