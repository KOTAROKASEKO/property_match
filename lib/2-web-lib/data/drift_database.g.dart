...
class $MessagesTable extends Messages
  ...
  static const VerificationMeta _whoSentMeta =
      const VerificationMeta('whoSent');
  @override
  late final GeneratedColumn<String> whoSent = GeneratedColumn<String>(
      'who_sent', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _whoReceivedMeta =
      const VerificationMeta('whoReceived');
  @override
  late final GeneratedColumn<String> whoReceived = GeneratedColumn<String>(
      'who_received', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  ...
  late final GeneratedColumn<String> repliedToMessageText =
      GeneratedColumn<String>('replied_to_message_text', aliasedName, true,
          type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _repliedToWhoSentMeta =
      const VerificationMeta('repliedToWhoSent');
  @override
  late final GeneratedColumn<String> repliedToWhoSent = GeneratedColumn<String>(
      'replied_to_who_sent', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
    ...
    if (data.containsKey('who_received')) {
      context.handle(
          ...
          whoReceived.isAcceptableOrUnknown(
              data['who_received']!, _whoReceivedMeta));
    } else if (isInserting) {
    ...
    if (data.containsKey('replied_to_message_text')) {
      context.handle(
          ...
          repliedToMessageText.isAcceptableOrUnknown(
              data['replied_to_message_text']!, _repliedToMessageTextMeta));
    }
    if (data.containsKey('replied_to_who_sent')) {
      context.handle(
          _repliedToWhoSentMeta,
          repliedToWhoSent.isAcceptableOrUnknown(
              data['replied_to_who_sent']!, _repliedToWhoSentMeta));
    }
  ...
  MessageRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return MessageRow(
      ...
      whoSent: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}who_sent'])!,
      whoReceived: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}who_received'])!,
      ...
      repliedToWhoSent: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}replied_to_who_sent']),
...
class MessageRow extends DataClass implements Insertable<MessageRow> {
  ...
  factory MessageRow.fromJson(Map<String, dynamic> json,
    ...
    return MessageRow(
      ...
      repliedToMessageText:
          serializer.fromJson<String?>(json['repliedToMessageText']),
...
class MessagesCompanion extends UpdateCompanion<MessageRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (repliedToMessageText.present) {
      map['replied_to_message_text'] =
          Variable<String>(repliedToMessageText.value);
    }
...
class $ChatThreadsTable extends ChatThreads
  ...
  late final GeneratedColumn<String> whoReceived = GeneratedColumn<String>(
      'who_received', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _hisNameMeta =
      const VerificationMeta('hisName');
  @override
  late final GeneratedColumn<String> hisName = GeneratedColumn<String>(
      'his_name', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _hisPhotoUrlMeta =
      const VerificationMeta('hisPhotoUrl');
  @override
  late final GeneratedColumn<String> hisPhotoUrl = GeneratedColumn<String>(
      'his_photo_url', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  ...
  late final GeneratedColumn<String> lastMessageId = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _unreadCountJsonMeta =
      const VerificationMeta('unreadCountJson');
  @override
  late final GeneratedColumn<String> unreadCountJson = GeneratedColumn<String>(
      'unread_count_json', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  ...
  late final GeneratedColumn<String> generalNote = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _generalImageUrlsMeta =
      const VerificationMeta('generalImageUrls');
  @override
  late final GeneratedColumnWithTypeConverter<List<String>, String>
      generalImageUrls = GeneratedColumn<String>(
              'general_image_urls', aliasedName, false,
              type: DriftSqlType.string,
              requiredDuringInsert: false,
              defaultValue: const Constant('[]'))
          .withConverter<List<String>>(
              $ChatThreadsTable.$convertergeneralImageUrls);
  static const VerificationMeta _viewingTimesMeta =
      const VerificationMeta('viewingTimes');
  @override
  late final GeneratedColumnWithTypeConverter<List<DateTime>, String>
      viewingTimes = GeneratedColumn<String>(
              'viewing_times', aliasedName, false,
              type: DriftSqlType.string,
              requiredDuringInsert: false,
              defaultValue: const Constant('[]'))
          .withConverter<List<DateTime>>(
              $ChatThreadsTable.$converterviewingTimes);
  static const VerificationMeta _viewingNotesMeta =
      const VerificationMeta('viewingNotes');
  @override
  late final GeneratedColumnWithTypeConverter<List<String>, String>
      viewingNotes = GeneratedColumn<String>(
              'viewing_notes', aliasedName, false,
              type: DriftSqlType.string,
              requiredDuringInsert: false,
              defaultValue: const Constant('[]'))
          .withConverter<List<String>>(
              $ChatThreadsTable.$converterviewingNotes);
  static const VerificationMeta _viewingImageUrlsMeta =
      const VerificationMeta('viewingImageUrls');
  @override
  late final GeneratedColumnWithTypeConverter<List<String>, String>
      viewingImageUrls = GeneratedColumn<String>(
              'viewing_image_urls', aliasedName, false,
              type: DriftSqlType.string,
              requiredDuringInsert: false,
              defaultValue: const Constant('[]'))
          .withConverter<List<String>>(
              $ChatThreadsTable.$converterviewingImageUrls);
  @override
  List<GeneratedColumn> get $columns => [
        id,
        whoSent,
  ...
  VerificationContext validateIntegrity(Insertable<ChatThreadRow> instance,
    ...
    if (data.containsKey('his_photo_url')) {
      context.handle(
          ...
          hisPhotoUrl.isAcceptableOrUnknown(
              data['his_photo_url']!, _hisPhotoUrlMeta));
    }
    ...
    if (data.containsKey('unread_count_json')) {
      context.handle(
          ...
          unreadCountJson.isAcceptableOrUnknown(
              data['unread_count_json']!, _unreadCountJsonMeta));
    }
    ...
    context.handle(_generalImageUrlsMeta, const VerificationResult.success());
    context.handle(_viewingTimesMeta, const VerificationResult.success());
    context.handle(_viewingNotesMeta, const VerificationResult.success());
    context.handle(_viewingImageUrlsMeta, const VerificationResult.success());
    return context;
  }
  ...
  ChatThreadRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ChatThreadRow(
      ...
      whoReceived: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}who_received'])!,
      hisName: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}his_name']),
      hisPhotoUrl: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}his_photo_url']),
      ...
      unreadCountJson: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}unread_count_json']),
      ...
      viewingTimes: $ChatThreadsTable.$converterviewingTimes.fromSql(
          attachedDatabase.typeMapping.read(
              DriftSqlType.string, data['${effectivePrefix}viewing_times'])!),
      viewingNotes: $ChatThreadsTable.$converterviewingNotes.fromSql(
          attachedDatabase.typeMapping.read(
              DriftSqlType.string, data['${effectivePrefix}viewing_notes'])!),
...
class ChatThreadRow extends DataClass implements Insertable<ChatThreadRow> {
  ...
  factory ChatThreadRow.fromJson(Map<String, dynamic> json,
    ...
    return ChatThreadRow(
      ...
      generalImageUrls:
          serializer.fromJson<List<String>>(json['generalImageUrls']),
      ...
      viewingImageUrls:
          serializer.fromJson<List<String>>(json['viewingImageUrls']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
...
class ChatThreadsCompanion extends UpdateCompanion<ChatThreadRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (generalImageUrls.present) {
      map['general_image_urls'] = Variable<String>($ChatThreadsTable
          .$convertergeneralImageUrls
          .toSql(generalImageUrls.value));
    }
    ...
    if (viewingImageUrls.present) {
      map['viewing_image_urls'] = Variable<String>($ChatThreadsTable
          .$converterviewingImageUrls
          .toSql(viewingImageUrls.value));
    }
    if (rowid.present) {
...
class $BlockedUsersTable extends BlockedUsers
  ...
  @override
  VerificationContext validateIntegrity(Insertable<BlockedUserRow> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class BlockedUserRow extends DataClass implements Insertable<BlockedUserRow> {
  ...
  BlockedUserRow copyWith({String? userId}) => BlockedUserRow(
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [messages, chatThreads, blockedUsers];
}
