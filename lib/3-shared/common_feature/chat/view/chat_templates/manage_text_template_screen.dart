...
//managing both agent and tenant template

class ManageTenantTemplatesScreen extends StatelessWidget {
  const ManageTenantTemplatesScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // The viewmodel is already provided by the parent route that will navigate here.
