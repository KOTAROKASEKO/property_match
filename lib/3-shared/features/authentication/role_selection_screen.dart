...
class _RoleSelectionScreenState extends State<RoleSelectionScreen> {
  ...
  Widget _buildSelectionView() {
    // 画面幅に応じてレイアウトを調整するためのLayoutBuilder（必要に応じて使用）
    // ここではExpandedを使ったRowでレスポンシブに対応します。
    return Center(
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 40), // スペースを少し広げる
              // ★★★ 変更点: RowとExpandedを使って横並びにする ★★★
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: _buildRoleCard(
                      context,
                      // 画像サイズを少し小さくして狭い画面でも崩れにくくする (120 -> 100)
                      iconDisplay: ClipOval(
                        child: Image.network(
                          'https://firebasestorage.googleapis.com/v0/b/whatsappclone-5ad8f.firebasestorage.app/o/tenant_pic.png?alt=media&token=405a5a9c-2e07-459f-b5ff-2d71e98baf03',
                          width: 100,
                          height: 100,
                          fit: BoxFit.cover,
                        ),
                  ...
                  const SizedBox(width: 16), // カード間のスペース
                  // --- Agent (List a room) ---
                  Expanded(
                    child: _buildRoleCard(
                      context,
                      iconDisplay: ClipOval(
                        child: Image.network(
                          'https://firebasestorage.googleapis.com/v0/b/whatsappclone-5ad8f.firebasestorage.app/o/agent_pic.png?alt=media&token=7be5ff1b-886f-42a7-85bd-61a33c317212',
                          width: 100,
                          height: 100,
                          fit: BoxFit.cover,
                        ),
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                textAlign: TextAlign.center,
                style: const TextStyle(
                  fontSize: 16, // フォントサイズを少し調整 (20 -> 16)
