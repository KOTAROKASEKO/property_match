...
class CreatePostScreen extends StatelessWidget {
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // ★ Added: Search Tags Section
                      _buildSectionCard(
                        title: 'Search Tags',
                        children: [
                          const Text(
                            'Select tags to help AI recommend this property accurately.',
                            style: TextStyle(fontSize: 12, color: Colors.grey),
                          ),
                          const SizedBox(height: 12),
                          _buildTagSelector(context, viewModel),
                        ],
                      ),
  ...
  Widget _buildTagSelector(BuildContext context, CreatePostViewModel viewModel) {
    return Wrap(
      spacing: 8.0,
      runSpacing: 8.0,
      children: kAvailableTags.map((tag) {
        final isSelected = viewModel.manualTags.contains(tag);
        return FilterChip(
          label: Text(tag),
          selected: isSelected,
