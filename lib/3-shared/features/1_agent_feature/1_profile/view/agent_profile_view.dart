...
import 'agent_post_detail_screen.dart';
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  return CustomScrollView(
                    slivers: [
                      SliverToBoxAdapter(
                          child: _ProfileHeader(viewModel: viewModel)),
                      SliverToBoxAdapter(child: const _ActionButtons()),

                      // ★★★ 2. 予約管理セクションを追加 ★★★
                      SliverToBoxAdapter(
                        child: ReservationSection(
                          agentId: userData.userId, // 自分のID
                          isAgentView: true, // エージェント管理モード(true)
                        ),
                      ),
                      // ★★★ 追加終了 ★★★
            ...
            return AgentPostGridCard(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        AgentPostDetailScreen(postId: post.id),
                  ),
                );
              },
            );
