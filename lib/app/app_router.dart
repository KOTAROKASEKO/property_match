...
import 'package:re_conver/3-shared/features/1_agent_feature/2_tenant_list/viewodel/deeplink_tenant_viewmodel.dart';
  ...
  routes: [
    ...
    GoRoute(
      ...
      builder: (context, state) {
        ...
        return DeepLinkTenantView(tenantId: tenantId);
      },
    ),
