...
import '3-shared/features/1_agent_feature/1_profile/view/agent_profile_view.dart';
...
void _handleMessage(RemoteMessage message) {
  ...
  // postIdには、commentの場合は投稿ID、reservationの場合はスロットIDが入る
  ...
  } else if (type == 'reservation' || type == 'reservation_cancel') {
    // 予約通知の場合は、予約管理ができる「マイプロフィール」画面へ遷移
    navigatorKey.currentState?.push(
      MaterialPageRoute(
