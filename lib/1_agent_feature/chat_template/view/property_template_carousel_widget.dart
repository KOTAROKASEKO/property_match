...
import 'package:re_conver/1_agent_feature/chat_template/view/agent_chat_template_create_screen.dart';
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (_) => const ManageAgentTemplatesScreen(),
                ));
              },
              child: const Text('Create a New Template'),
            ),
          ],
        ),
      );
